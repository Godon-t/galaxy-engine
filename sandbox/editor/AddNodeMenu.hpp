...
class AddNodeMenu {
private:
    const std::vector<std::string> m_nodeTypes = { "Node", "Node3D", "Camera", "MeshInstance", "MultiMeshInstance", "Sprite3D", "EnvironmentNode", "SpotLight", "PointLight", "GINode", "CornellBox" };
